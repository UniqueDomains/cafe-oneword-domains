...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C386%20rows-8250df">
...
**Public extract:** 8,386 rows · **Live catalog:** 8,386 domains
...
- `cafe.csv` — public CSV extract (8,386 rows)
- `cafe.json` — public JSON extract (8,386 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,386-row public sample | 8,386 live domains                               |
...
> Unique Domains. *Available .CAFE One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
